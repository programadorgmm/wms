...
/**
 * ZedSupplierShippingUnitBarcode
 *
 * @ORM\Table(
 *  name="zed_supplier_shipping_unit_barcode",
 *  indexes={@ORM\Index(name="zed_supplier_shipping_unit_barcode_fk_zed_product", columns={"zed_product"}),
 * @ORM\Index(name="zed_supplier_shipping_unit_barcode_index_barcode", columns={"barcode"})}
 * )
 * @ORM\Entity(repositoryClass="Natue\Bundle\ZedBundle\Repository\ZedSupplierShippingUnitBarcodeRepository")
 */
class ZedSupplierShippingUnitBarcode implements HasMultiplierQuantity
{
    /**
     * @var integer

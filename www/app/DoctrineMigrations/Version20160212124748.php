 ...
 */
class Version20160212124748 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE zed_supplier_shipping_unit_barcode (id int not null auto_increment,barcode VARCHAR(255) NOT NULL, zed_product INT DEFAULT NULL, multiplier VARCHAR(255) NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX zed_supplier_shipping_unit_barcode_fk_zed_product (zed_product), INDEX zed_supplier_shipping_unit_barcode_index_barcode (barcode), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zed_supplier_shipping_unit_sku (id int not null auto_increment,sku VARCHAR(255) NOT NULL, zed_product INT DEFAULT NULL, multiplier VARCHAR(255) NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX zed_supplier_shipping_unit_sku_fk_zed_product (zed_product), INDEX zed_supplier_shipping_unit_sku_index_sku (sku), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zed_supplier_sku (id int not null auto_increment, sku VARCHAR(255) NOT NULL, zed_product INT DEFAULT NULL, multiplier VARCHAR(255) NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX zed_supplier_sku_fk_zed_product (zed_product), INDEX zed_supplier_sku_index_sku (sku), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
